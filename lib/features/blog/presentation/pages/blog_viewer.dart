...
class BlogViewer extends StatelessWidget {
  ...
  static route(Blog blog) => MaterialPageRoute(builder: (context) => BlogViewer(blog: blog,));
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('${formatDateBydMMMYYY(blog.updatedAt)} . ${calculateReadingTime(blog.content)} min',style: const TextStyle(color: AppPalette.greyColor,fontSize: 16,fontWeight: FontWeight.w500),),
                const SizedBox(height: 20),
                ClipRRect(
